...
\newcommand{\confname}{EAMT 2018}
\newcommand{\website}{http://eamt2018.dlsi.ua.es/}
\newcommand{\urlwebsite}{http://eamt2018.dlsi.ua.es/}
\newcommand{\contactname}{the general chair, Mikel L.\ Forcada}
\newcommand{\contactemail}{\texttt{mlf@ua.es}}
\newcommand{\conffilename}{eamt18}
\newcommand{\downloadsite}{http://eamt2018.dlsi.ua.es\#templates}
...
This document is derived from the instructions for EAMT 2017 % update this list at next change
...
If you are using Overleaf, you can use this document as a template for your submission. Simply create a clone of this read-only document by clicking ``Clone this project'' (see Figure~\ref{fig:clone_ex}) link in a green box at the top of the document editing window. You can then modify the newly created document.

\begin{figure*}
 \centering
 \includegraphics[scale=0.5]{clone_example}
 \caption{How to clone this template}\label{fig:clone_ex}
\end{figure*}
